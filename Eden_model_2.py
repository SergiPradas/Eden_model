...
def function_evolution(L,n,active_coord,colony):
    ...
    #I volem retornar com a sortida de la funció:
    return n, active_coord, colony #Treu els resultats en un tuple.
...
fig = plt.figure()
ax = plt.axes()
ax.set_title('Bacterial_Evolution')
while n < 100:
    n, active_coord, colony = function_evolution(n,L,active_coord,colony)
